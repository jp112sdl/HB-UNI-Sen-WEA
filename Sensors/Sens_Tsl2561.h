...
public:
  ...
  void init () {
    ...
    if (i > 0) {
      ...
      DPRINTLN(F("Success: found TSL2561 sensor"));
    }
    else {
      DPRINTLN(F("Error: no TSL2561 sensor found"));
    }
  }
  ...
  void measure () {
    if (_present == true) {
      ...
      DPRINT(F("TSL2561 Brightness Full: ")); DDECLN(_brightnessFull);
      DPRINT(F("TSL2561 Brightness IR  : ")); DDECLN(_brightnessIR);
      DPRINT(F("TSL2561 Brightness Vis : ")); DDECLN(_brightnessVis);
      DPRINT(F("TSL2561 Brightness Lux : ")); DDECLN(_brightnessLux);
    }
  }
